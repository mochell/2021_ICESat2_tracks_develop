...
plt.fill_between(  T3_small[x_key]/xscale, uncertainty_y + T3_small['heights_c_std'] /2 , y2=uncertainty_y-T3_small['heights_c_std'] /2, color=col.cascade2,alpha=1, label='uncertrainty')
