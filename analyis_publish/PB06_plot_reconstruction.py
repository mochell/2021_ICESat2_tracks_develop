...
# %%
    ...
    gs = GridSpec(30,6,  wspace=0,  hspace=0.2)#figure=fig,
    ...
    B07_sel=B07[b][(T3_sel['delta_time'].min() < B07[b]['time']['delta_time']) & (B07[b]['time']['delta_time'] < T3_sel['delta_time'].max()) ]
    ...
    ax41 = F.fig.add_subplot(gs[3:7, 4:])
